...
CREATE TABLE IF NOT EXISTS t_work (
  ...
  work_status VARCHAR(20) DEFAULT 'finished' COMMENT '作品状态：practice-练习样件, finished-正式成品, repair-修复件, semi_finished-半成品',
...
INSERT INTO t_work (user_id, title, cover, content, materials, material_summary, material_brief, craft_steps, category_id, craft_type_id, difficulty, work_status, view_count, favorite_count, status) VALUES
(1, '手工植鞣革短夹制作教程', 'https://picsum.photos/400/300?random=1', 
 ...
 '1. 裁下料片\n2. 打斩\n3. 缝制\n4. 封边\n5. 安装五金',
 1, 1, 'intermediate', 'finished', 128, 45, 1),
(1, '复古风卡包制作分享', 'https://picsum.photos/400/300?random=2',
 ...
 '1. 设计版型\n2. 裁切皮料\n3. 制作卡位\n4. 组合缝制\n5. 磨边封边',
 2, 3, 'intermediate', 'practice', 256, 89, 1),
(1, '手工皮带的封边技巧', 'https://picsum.photos/400/300?random=3',
 ...
 '1. 裁皮带\n2. 削薄尾部\n3. 粗磨\n4. 床面处理\n5. 细磨\n6. 抛光',
 3, 5, 'intermediate', 'semi_finished', 512, 156, 1);
